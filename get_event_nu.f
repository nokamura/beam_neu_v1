      subroutine get_event_nu(z,hErec)
C     ****************************************************
...
c      if (iNC.eq.1) then
c         icc = 2                ! NC interactions
c         iproc = 3              ! NC events for ismear = 0, NCpi0_bg for ismear = 1 
cc         call get_event(z,iproc,hErec(1,1,iproc),nevent_tmp)
c         call get_event(z,iproc,hErec(1,1,iproc))
c      endif
